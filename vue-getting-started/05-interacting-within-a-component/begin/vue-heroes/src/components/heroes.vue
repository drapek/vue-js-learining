...
const ourHeroes = [
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 3,
    originDate: format(new Date(2003, 2, 1), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 2,
    originDate: format(new Date(1234, 12, 1), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 0,
    originDate: format(new Date(2035, 2, 12), inputDateFormat),
...
export default {
  ...
  methods: {
    ...
    async loadHeros() {
      this.herose = [];
      this.message = 'Loading the Heroes. Please wait.';
  ...
  watch: {
    'selectedHero.capeCounter': {
      ...
      handler(newValue, oldValue) {
        console.log(
          `Watcher is evaluted. Old val=${oldValue}, new=${newValue}`
        );
